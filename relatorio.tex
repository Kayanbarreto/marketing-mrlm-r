...
\begin{table}[H]
\centering
\caption{Coeficientes estimados do modelo}
\input{tables_latex/tabela_coeficientes.tex}
\end{table}
...
\input{tables_latex/tabela_pressupostos.tex}
\end{table}
...
\input{tables_latex/tabela_vif.tex}
\end{table}
...
\begin{table}[H]
\centering
\caption{Previsões pontuais e intervalos}
\input{tables_latex/tabela_previsoes.tex}
\end{table}
